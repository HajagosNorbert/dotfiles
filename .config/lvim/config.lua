...
lvim.keys.normal_mode["<leader>o"] = ":call append(line('.'), '')<CR>"
lvim.keys.normal_mode["<leader>O"] = ":call append(line('.')-1, '')<CR>"
...
lvim.builtin.which_key.mappings["ds"] = {
  ...
  "Start debugging (DAP or RustDebuggables)",
}
